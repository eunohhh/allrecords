...
export function GraphToolbar(props: {
	...
	return (
		<div className="mb-3 flex flex-wrap items-center gap-2">
			<div className="font-medium text-sm text-zinc-700 dark:text-zinc-200">
				Historian Graph
			</div>
				...
				<div className="flex flex-wrap items-center gap-3 rounded-md border border-zinc-200 px-3 py-2 text-xs text-zinc-600 dark:border-zinc-800 dark:text-zinc-300">
					<label className="flex items-center gap-1">
						<input
							...
							onChange={(e) => props.setShowEvents(e.target.checked)}
						/>
						events
					</label>
					<label className="flex items-center gap-1">
						<input
							...
							onChange={(e) => props.setShowTopics(e.target.checked)}
						/>
						topics
					</label>
					<label className="flex items-center gap-1">
						<input
							...
							onChange={(e) => props.setShowTags(e.target.checked)}
						/>
						tags
					</label>
					<label className="flex items-center gap-1">
						<input
							...
							onChange={(e) => props.setShowPeople(e.target.checked)}
						/>
						people
					</label>
