...
export function GraphCanvas(props: {
	...
	const inverseScale = 1 / Math.max(props.transform.k, 0.2);
	const labelFontSize = Math.max(8, Math.min(12, 11 * inverseScale));
	const labelOffset = Math.max(10, 16 * inverseScale);
	return (
		<div
